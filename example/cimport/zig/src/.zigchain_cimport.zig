...
pub const CImportKind_invalid: c_int = 0;
pub const CImportKind_point: c_int = 1;
pub const CImportKind_blob: c_int = 2;
pub const CImportKind_packet: c_int = 3;
pub const enum_CImportKind = c_uint;
pub const CImportKind = enum_CImportKind;
pub const struct_CImportPoint = extern struct {
    x: i32 = 0,
    y: i32 = 0,
...
pub const union_CImportValue = extern union {
    as_i64: i64,
    as_f64: f64,
    as_str: [*c]const u8,
    as_point: CImportPoint,
};
pub const CImportValue = union_CImportValue;
pub const struct_CImportPacket = extern struct {
    kind: CImportKind = @import("std").mem.zeroes(CImportKind),
    flags: u32 = 0,
    count: usize = 0,
    bytes: [16]u8 = @import("std").mem.zeroes([16]u8),
    points: [2]CImportPoint = @import("std").mem.zeroes([2]CImportPoint),
    value: CImportValue = @import("std").mem.zeroes(CImportValue),
    pub const cimport_packet_checksum = __root.cimport_packet_checksum;
    pub const checksum = __root.cimport_packet_checksum;
};
pub const CImportPacket = struct_CImportPacket;
pub const struct_CImportNode = extern struct {
    id: i32 = 0,
    kind: CImportKind = @import("std").mem.zeroes(CImportKind),
    point: CImportPoint = @import("std").mem.zeroes(CImportPoint),
    value: CImportValue = @import("std").mem.zeroes(CImportValue),
    next: [*c]struct_CImportNode = null,
    pub const cimport_node_append = __root.cimport_node_append;
    pub const cimport_node_destroy = __root.cimport_node_destroy;
    pub const cimport_node_count = __root.cimport_node_count;
    pub const cimport_node_sum = __root.cimport_node_sum;
    pub const append = __root.cimport_node_append;
    pub const destroy = __root.cimport_node_destroy;
    pub const count = __root.cimport_node_count;
    pub const sum = __root.cimport_node_sum;
};
pub const CImportNode = struct_CImportNode;
pub const struct_CImportTable = extern struct {
    length: usize = 0,
    packets: [*c]const CImportPacket = null,
};
...
pub const CImportAccumulator = struct_CImportAccumulator;
pub extern fn cimport_make_packet(kind: CImportKind, x: i32, y: i32) CImportPacket;
pub extern fn cimport_point_make(x: i32, y: i32) CImportPoint;
pub extern fn cimport_value_from_int(value: i64) CImportValue;
pub extern fn cimport_value_from_double(value: f64) CImportValue;
pub extern fn cimport_value_from_string(value: [*c]const u8) CImportValue;
pub extern fn cimport_node_create(id: i32, kind: CImportKind, point: CImportPoint, value: CImportValue) [*c]CImportNode;
pub extern fn cimport_node_append(head: [*c]CImportNode, node: [*c]CImportNode) [*c]CImportNode;
pub extern fn cimport_node_destroy(node: [*c]CImportNode) void;
pub extern fn cimport_node_count(node: [*c]const CImportNode) usize;
...
pub const CIMPORT_STRESS_H = "";
pub const CIMPORT_CALLBACKS_H = "";
...
pub const CIMPORT_TYPES_H = "";
pub const CIMPORT_MAGIC = __helpers.promoteIntLiteral(c_int, 0x1f2e3d4c, .hex);
pub const CIMPORT_LABEL_MAX = @as(c_int, 32);
